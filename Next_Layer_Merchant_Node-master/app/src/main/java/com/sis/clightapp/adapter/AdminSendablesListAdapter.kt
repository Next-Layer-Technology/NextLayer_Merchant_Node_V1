...
class AdminSendablesListAdapter(private val mContext: Context, @LayoutRes list: List<Refund>) : ArrayAdapter<Refund?>(
    mContext, 0, list
) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        amountsat.text = excatFigure(round(mSatoshoToBtc(currentRefund.msatoshi), 9)) + "BTC"
